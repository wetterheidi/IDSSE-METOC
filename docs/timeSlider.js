 ...
 * icon_eu) werden rein geometrisch geprüft -- KEIN API-Request. Diese Funktion
 * lief bisher für JEDES gezeichnete Prüfgebiet einmal PRO Modell gegen die
 * öffentliche API (bei 13 Modellen 13 Requests), unabhängig vom später
 * gewählten Modell -- Haupttreiber wiederholter 429er. Für Modelle OHNE
 * bekannte Bbox bleibt der bisherige Live-Probe bestehen (unveränderte
 * Semantik, inkl. dem seltenen Fall "geografisch abgedeckt, aber für diesen
 * Tag keine Daten").
 */
